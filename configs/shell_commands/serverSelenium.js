 ...
 */
const seleniumServerCommand = ['xfce4-terminal --tab','java -jar -Dwebdriver.gecko.driver=./configs/geckodriver/geckodriver ./configs/geckodriver/selenium_server.jar ;'];
